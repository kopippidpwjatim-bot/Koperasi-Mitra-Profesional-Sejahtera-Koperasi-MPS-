...
export const COURSE_1_SVG = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 250" width="100%" height="100%">
  ...
  <text x="200" y="230" font-family="sans-serif" font-size="12" fill="%2394a3b8" text-anchor="middle">Koperasi Mitra Profesional Sejahtera</text>
</svg>`;
...
export const DEFAULT_LMS_COURSES: LMSCourse[] = [
  {
    ...
    description: 'Membekali anggota dengan pemahaman mendalam tentang prinsip koperasi modern, hak & kewajiban partisipasi, pengelolaan simpanan modal, serta pengawasan akuntabilitas organisasi Koperasi MPS.',
    duration: '1.5 Jam',
    image: COURSE_1_SVG,
    lessons: [
      {
        id: 'c1-l1',
        title: 'Pengantar Koperasi MPS',
        content: `<h3>Selamat Datang di Portal Pembelajaran Koperasi MPS</h3>
<p>Koperasi Mitra Profesional Sejahtera (Koperasi MPS) didirikan dengan visi luhur untuk meningkatkan kesejahteraan pensiunan, profesional, serta pelaku UMKM binaan. Melalui platform gotong royong ini, setiap anggota bukan hanya sekadar nasabah, melainkan pemilik sah dari Koperasi.</p>
...
<p>Koperasi MPS menggunakan skema permodalan gotong royong yang dibagi menjadi beberapa komponen berdasar Anggaran Dasar/Anggaran Rumah Tangga (AD/ART):</p>
<ol>
...
<p>Koperasi MPS menyediakan sistem penyaluran pinjaman produktif bagi anggota dengan tenor pembayaran yang bersahabat dan bunga bersaing (1% per bulan flat). Pengajuan dapat diajukan langsung melalui Dashboard Anggota dan akan divalidasi langsung oleh Pengurus (Admin, Sekretaris, Bendahara, dan Ketua).</p>`,
        duration: '20 Menit',
        order: 2
      },
      {
  ...
  <li><b>Pembagian Sisa Hasil Usaha (SHU):</b> Menerima pembagian keuntungan di akhir tahun buku secara proporsional sesuai dengan keaktifan transaksi dan besaran simpanan masing-masing di koperasi.</li>
    ...
    quiz: {
      ...
      questions: [
        {
          id: 'q1-1',
          questionText: 'Siapakah pemilik tertinggi dari kekuasaan dan keputusan di Koperasi MPS?',
          options: [
            'Ketua Koperasi saja',
        ...
        {
          id: 'q1-3',
          questionText: 'Berapakah persen suku bunga flat per bulan yang ditawarkan Koperasi MPS untuk pinjaman anggota?',
          options: [
            '1.0% flat per bulan',
            '5.5% flat per bulan',
...
<ul>
  ...
  <li><b>Interest (Ketertarikan):</b> Jelaskan fakta menarik atau masalah yang sedang dihadapi calon pembeli. <br><i>Contoh: "Koperasi MPS kini menyediakan Beras Premium sehat tanpa bahan pemutih kimia langsung dari petani lokal."</i></li>
